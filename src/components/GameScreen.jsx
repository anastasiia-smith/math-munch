...
const createAnswerOptions = (correctAnswer) => {
  ...
  while (optionSet.size < 3) {
    ...
    const candidate = Math.max(0, Math.min(20, correctAnswer + distance * direction))
...
const playTone = (context, frequency, duration, type = 'sine', volume = 0.04, delay = 0) => {
  ...
  return (
    <section className="game-card">
      ...
      <header className="game-header">
        <img className="monster-image" src={monsterImage} alt="Cute green candy monster" />
      ...
      <ScoreBoard score={score} questionNumber={currentQuestion} totalQuestions={totalQuestions} />
